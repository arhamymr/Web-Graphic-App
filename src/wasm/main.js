...
var ASM_CONSTS = {
 ...
 150960: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 151043: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 151112: () => { return window.innerWidth; },  
 151142: () => { return window.innerHeight; }
};
